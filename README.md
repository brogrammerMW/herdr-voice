...
swift test           # 76 tests: events, Herdr tools, focus, confirmations, injection gates, shell, speech policy, activity, window pinning, reconnect, keychain, speech gate, stop phrases
swift build -c release
```
